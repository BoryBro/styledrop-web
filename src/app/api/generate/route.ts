...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  // v3 (2026-03-30): 탑승 위치 명확화 — 인물은 뒷자리 승객
  "grab-selfie": "Place this person as the rear passenger on a motorcycle in a busy city street, taking a high-angle selfie.\n\nSEATING POSITION: The person sits on the BACK SEAT of the motorcycle, behind the driver. The driver is in FRONT of the person, with their back facing the person. The person is behind the driver, taking a selfie looking forward over the driver's shoulder.\n\nPERSON: Keep the same face, same facial features, same expression from the original photo.\n\nCLOTHING TRANSFORMATION: Regardless of what the person is wearing in the original photo, dress them in lightweight Southeast Asian summer clothing — a casual short-sleeve shirt or thin breathable top appropriate for hot, humid tropical weather. Do not keep winter clothes, jackets, or heavy layers.\n\nSCENE SETUP:\n- The person (rear passenger) wears a plain solid-color motorcycle helmet (no brand logos, no text, no markings) and black sunglasses\n- The driver in front has their back to the camera, wearing a plain helmet (no logos, no text) and a face mask\n- Both are on a moving motorcycle, driver in front, person in back\n\nENVIRONMENT:\n- Bustling Southeast Asian city street with glass high-rise buildings\n- Other motorcycles and vehicles sharing the road\n- Green trees lining the street\n- Intense tropical sunlight — harsh, direct midday sun casting strong sharp shadows. Bright highlights on skin and surfaces. The light feels hot, blazing, and real.\n\nCAMERA & COMPOSITION:\n- High-angle selfie perspective, shot by the rear passenger extending their arm forward\n- The driver's helmet and back are visible in the lower foreground\n- Wide-angle lens distortion typical of a phone front camera\n- Motion feel: windblown hair, slight motion blur on background\n\nAESTHETIC: Vibrant, hyper-realistic travel photo. Raw midday sun energy. The sweaty, alive feeling of riding through a hot Asian city. No brand text or logos anywhere in the image."
