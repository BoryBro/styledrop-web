...
const STYLE_PROMPTS: Record<string, Record<string, string>> = {
  ...
  "joseon-farmer": {
    ...
    // v2 — 레퍼런스1 이미지 + 스타일 트랜스퍼 방식
    "v2": "Joseon Dynasty Korean farmer portrait transformation. Preserve the person's facial identity completely — bone structure, eye shape, nose, lips, proportions, same expression and gaze. Face must naturally integrate into the scene (same lighting, contrast, film grain, sepia tone). No beautification. Add surface weathering: sun damage, rough pores from outdoor labor. Replace hair completely with authentic Joseon-era farmer hair (topknot 상투, or short roughly-cut, unwashed, coarse). Dress in traditional hemp work clothing (삼베옷), worn and dirty. Photograph quality: early 1900s glass plate, heavy analog film grain, slight global softness, low contrast, sepia/warm brown tone uniformly applied, aged degradation. Raw, documentary, physically aged. Must feel 100+ years old.",

    // v3 — 레퍼런스1 장면을 텍스트로 직접 묘사
    ...
    // v4 — 레퍼런스2 이미지 + 스타일 트랜스퍼 방식
    "v4": "Joseon Dynasty Korean farmer portrait transformation. Preserve the person's facial identity completely — bone structure, eye shape, nose, lips, proportions, same expression and gaze. Face must naturally integrate into the scene (same lighting, contrast, film grain, sepia tone). No beautification. Add surface weathering: sun damage, rough pores from outdoor labor. Replace hair completely with authentic Joseon-era farmer hair (topknot 상투, or short roughly-cut, unwashed, coarse). Dress in traditional hemp work clothing (삼베옷), worn and dirty. Photograph quality: early 1900s glass plate, heavy analog film grain, slight global softness, low contrast, sepia/warm brown tone uniformly applied, aged degradation. Raw, documentary, physically aged. Must feel 100+ years old.",

    // v5 — 레퍼런스2 장면을 텍스트로 직접 묘사
...
const STYLE_REFERENCES: Record<string, Record<string, string[]>> = {
  ...
  "joseon-farmer": {
    ...
    "v3": [],
    "v4": ["references/joseon-farmer-2.jpg"],
    "v5": [],
  },
  "grab-selfie":     { "default": [] },
  "gyaru":           { "default": [] },
