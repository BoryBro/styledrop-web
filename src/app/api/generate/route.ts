...
const STYLE_PROMPTS: Record<string, Record<string, string>> = {
  ...
  "gyaru": {
    ...
    // v1 (2026-04-01): 다크 갸루
    "dark": "CRITICAL IDENTITY LOCK — ABSOLUTE: preserve the face with 100% fidelity. Do NOT alter bone structure, face shape, eye distance, or proportions. Only apply surface-level cosmetic effects ON TOP of the original face.\n\nCORE TRANSFORMATION:\nApply a dark/gothic gyaru (ギャル) makeup filter — gothic lolita meets aggressive dark gyaru.\n\nDARK GYARU FACE FILTER:\n- Smoky black eyeshadow extending far beyond outer corners\n- Intensely layered black false eyelashes, heavy both top and bottom\n- Harsh black gel liner with dramatic cat-eye flick\n- Dark burgundy or black circle lenses (deep, void-like)\n- White under-eye highlight (strong tear-bag) for doll-like contrast\n- High-contrast pale foundation — near porcelain white, cold undertone\n- Deep berry, wine, or black lip color — fully matte\n- No warm blush; cool contour only\n\nHAIR:\n- Jet black or deep burgundy, voluminous gyaru curls\n- High shine, slightly lacquered texture\n\nSCENE & AESTHETIC:\n- Dark moody background: deep purple / midnight gradient\n- Sparkle and star bokeh effects, silver/black glitter accents\n- Gothic purikura frame: black lace border, dark pearls, cross motifs, silver rhinestones\n- Slight blue-cool color grade over the entire image\n- Old mobile camera grain/noise texture\n\nSTRICT RULES:\n- NO face reshaping or identity drift\n- NO modern goth aesthetic — must feel like 2000s Japanese dark gyaru purikura\n- Preserve exact likeness of the original person",
    // v1 (2026-04-01): 핑쿠 갸루
    "pinku": "CRITICAL IDENTITY LOCK — ABSOLUTE: preserve the face with 100% fidelity. Do NOT alter bone structure, face shape, eye distance, or proportions. Only apply surface-level cosmetic effects ON TOP of the original face.\n\nCORE TRANSFORMATION:\nApply a pink/kawaii gyaru (ギャル) makeup filter — ultra-sweet, hyper-feminine, candy-colored.\n\nPINKU GYARU FACE FILTER:\n- Soft shimmery pink eyeshadow covering the lid\n- Extra-long curled false eyelashes with pink glitter at the tips\n- Light brown liner with subtle lower lash dots\n- Bright rose-pink circle lenses (large, sparkly iris)\n- Exaggerated rosy blush covering full cheeks and nose bridge\n- Warm ivory skin base — soft and dewy, not matte\n- Glossy, overlined pink lips — candy-pink or coral\n\nHAIR:\n- Bright bubblegum pink or platinum blonde, heavily layered voluminous curls\n- Shiny, candy-like texture with slight iridescence\n\nSCENE & AESTHETIC:\n- Pastel pink background with soft heart bokeh and star sparkles\n- Kawaii purikura frame: pastel pink border, hearts, stars, ribbon motifs, pearl accents\n- Warm candy-pink color grade over the entire image\n- High saturation, slight warm glow\n- Retro flip-phone camera texture with soft grain\n\nSTRICT RULES:\n- NO face reshaping or identity drift\n- NO modern K-beauty aesthetic — must feel like 2000s Japanese kawaii gyaru purikura\n- Preserve exact likeness of the original person",
  },
};
