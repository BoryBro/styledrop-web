...
const STYLE_PROMPTS: Record<string, Record<string, string>> = {
  ...
  // v4: 얼굴 100% 보존 강화 + 성별 유지 + 랜덤 3안 (v1 텍스트전용 / v2 ref-1 / v3 ref-2)
  "joseon-farmer": {
    // 공통 베이스 (v1 — 레퍼런스 없음, 정면 포즈)
    "v1": "Transform this photo into a Joseon Dynasty Korean farmer portrait.\n\nThis must look like a real historical photograph from 1900–1920s Korea — completely unretouched, raw, aged, and documentary. Not artistic. Not stylized. Real.\n\nFACE — ABSOLUTE TOP PRIORITY — DO NOT ALTER UNDER ANY CIRCUMSTANCES:\n- The subject's face is the single most important element. Reproduce it with 100% fidelity.\n- Every facial feature must be transferred exactly: eye shape (including single/double eyelid), eye spacing, nose bridge height and width, lip thickness and shape, jaw line, cheekbone position, chin shape, overall face proportions\n- If the subject is female, ALL feminine facial characteristics must be fully preserved — soft jaw, delicate features, feminine bone structure. Do NOT masculinize the face.\n- If the subject is male, preserve all masculine characteristics.\n- Same skin tone mapped through the sepia filter — relative lightness/darkness must match\n- Same expression and gaze direction\n- The face must be seamlessly integrated: same film grain, same sepia tone, same contrast as the rest of the image — never looks pasted\n- Absolutely no beautification, no smoothing, no idealization — but also no distortion of original features\n- Add only surface-level historical weathering (rough pores, slight sun damage) without changing facial structure\n\nHAIR — MUST CHANGE COMPLETELY:\n- Do NOT preserve the original hairstyle\n- Replace with authentic Joseon-era farmer hair\n- Male: small topknot (상투) at crown, or very short roughly-cut hair\n- Female: simple low bun or braided hair tied back, typical of Joseon-era working women\n- Hair must look unwashed, coarse, unstyled\n\nCLOTHING:\n- Traditional Korean hemp work clothing (삼베옷)\n- Loose jeogori top and wide baji pants (male) or jeogori with chima skirt (female)\n- Coarse, worn fabric — visible fibers, dirt stains, sweat marks\n- No clean edges, no modern tailoring\n\nSCENE — FRONTAL PORTRAIT:\n- Subject facing camera directly, standing upright\n- Holding a simple wooden farming tool (hoe or rake) at their side\n- Full body visible head to toe\n- Wide dry Korean farmland, flat horizon, harvested field\n- Yellow-brown dry grass and soil, pale overcast sky\n\nPHOTOGRAPH QUALITY:\n- Early 1900s glass plate photograph\n- Heavy coarse analog film grain across entire image including face\n- Slight global softness, low contrast, washed-out highlights, lifted blacks\n- Sepia/warm brown tone applied uniformly across entire image\n- Slight degradation as if scanned from aged print — raw, documentary, physically aged",

    // v2 — 레퍼런스 1 참고 + 농사 작업 포즈
    "v2": "Transform this photo into a Joseon Dynasty Korean farmer portrait.\n\nThis must look like a real historical photograph from 1900–1920s Korea — completely unretouched, raw, aged, and documentary. Not artistic. Not stylized. Real.\n\nFACE — ABSOLUTE TOP PRIORITY — DO NOT ALTER UNDER ANY CIRCUMSTANCES:\n- The subject's face is the single most important element. Reproduce it with 100% fidelity.\n- Every facial feature must be transferred exactly: eye shape (including single/double eyelid), eye spacing, nose bridge height and width, lip thickness and shape, jaw line, cheekbone position, chin shape, overall face proportions\n- If the subject is female, ALL feminine facial characteristics must be fully preserved — soft jaw, delicate features, feminine bone structure. Do NOT masculinize the face.\n- If the subject is male, preserve all masculine characteristics.\n- Same skin tone mapped through the sepia filter\n- Same expression and gaze direction\n- The face must be seamlessly integrated with the same film grain, sepia tone, and contrast as the rest of the image\n- No beautification, no smoothing — only surface-level weathering without altering facial structure\n\nHAIR — MUST CHANGE COMPLETELY:\n- Replace with authentic Joseon-era farmer hair\n- Male: topknot (상투) or short roughly-cut hair\n- Female: simple low bun or braided hair tied back\n- Unwashed, coarse, unstyled\n\nCLOTHING:\n- Traditional Korean hemp work clothing (삼베옷)\n- Male: jeogori top and baji pants. Female: jeogori with chima skirt\n- Worn, dirty fabric — coarse fibers, sweat stains, no modern tailoring\n\nSCENE — WORKING POSE:\n- Subject actively working in the field — bent forward hoeing, swinging a tool, crouching to harvest, or carrying bundled crops on their back\n- Dynamic working posture, not standing still\n- Full body visible head to toe\n- Wide dry Korean farmland, harvested rice paddy or dry field\n- Flat horizon, pale sky, yellow-brown earth\n\nPHOTOGRAPH QUALITY:\n- Early 1900s glass plate photograph\n- Heavy coarse analog film grain, slight global softness\n- Low contrast, washed-out highlights, sepia/warm brown tone uniformly applied\n- Degraded as if scanned from aged print — raw, documentary, physically aged",

    // v3 — 레퍼런스 2 참고 + 3/4 측면 포즈
    "v3": "Transform this photo into a Joseon Dynasty Korean farmer portrait.\n\nThis must look like a real historical photograph from 1900–1920s Korea — completely unretouched, raw, aged, and documentary. Not artistic. Not stylized. Real.\n\nFACE — ABSOLUTE TOP PRIORITY — DO NOT ALTER UNDER ANY CIRCUMSTANCES:\n- The subject's face is the single most important element. Reproduce it with 100% fidelity.\n- Every facial feature must be transferred exactly: eye shape (including single/double eyelid), eye spacing, nose bridge height and width, lip thickness and shape, jaw line, cheekbone position, chin shape, overall face proportions\n- If the subject is female, ALL feminine facial characteristics must be fully preserved — soft jaw, delicate features, feminine bone structure. Do NOT masculinize the face.\n- If the subject is male, preserve all masculine characteristics.\n- Same skin tone mapped through the sepia filter\n- The face must be seamlessly integrated with the same film grain, sepia tone, and contrast as the rest of the image\n- No beautification, no smoothing — only surface-level weathering without altering facial structure\n\nHAIR — MUST CHANGE COMPLETELY:\n- Replace with authentic Joseon-era farmer hair\n- Male: topknot (상투) or short roughly-cut hair\n- Female: simple low bun or braided hair tied back\n- Unwashed, coarse, unstyled\n\nCLOTHING:\n- Traditional Korean hemp work clothing (삼베옷)\n- Male: jeogori top and baji pants. Female: jeogori with chima skirt\n- Worn, dirty fabric — coarse fibers, sweat stains, no modern tailoring\n\nSCENE — 3/4 ANGLE PORTRAIT:\n- Subject at a slight 3/4 angle, body turned slightly to one side, face turned toward camera\n- Resting on a farming tool or standing with tool planted in ground beside them\n- Full body visible head to toe\n- Wide dry Korean farmland, flat horizon\n- Overcast natural daylight, yellow-brown soil\n\nPHOTOGRAPH QUALITY:\n- Early 1900s glass plate photograph\n- Heavy coarse analog film grain, slight global softness\n- Low contrast, washed-out highlights, sepia/warm brown tone uniformly applied\n- Degraded as if scanned from aged print — raw, documentary, physically aged",
  },
...
const STYLE_REFERENCES: Record<string, Record<string, string[]>> = {
  ...
  "joseon-farmer": {
    "v1": [],
    "v2": ["references/joseon-farmer-1.jpg"],
    "v3": ["references/joseon-farmer-2.jpg"],
  },
  "grab-selfie":     { "default": [] },
  "gyaru":           { "default": [] },
  // 천사 변신 — 레퍼런스 멀티모달 활성화
