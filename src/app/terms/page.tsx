    ...
    <main className="flex-1 w-full max-w-3xl mx-auto px-6 py-16 flex flex-col min-h-screen text-white/90">
      ...
      <div className="space-y-8 text-sm md:text-base leading-relaxed break-keep bg-card/50 p-6 md:p-8 rounded-2xl border border-white/5 shadow-2xl">
        ...
        <section>
          ...
          <p>본 약관은 StyleDrop(이하 "서비스")이 제공하는 AI 이미지 변환 서비스 및 크레딧 기반 유료 부가 서비스 이용에 관하여 서비스와 이용자 간의 권리, 의무 및 책임 사항을 규정함을 목적으로 합니다.</p>
        </section>

        <section>
          <h2 className="text-xl font-bold mb-3 text-white">제 2조 (서비스 내용)</h2>
          <p>StyleDrop은 Google Gemini AI 모델을 기반으로 사용자의 사진에 다양한 스타일(플래시 필터, 오토바이 셀카, 픽셀 캐릭터 등)을 적용하여 변환 이미지를 제공하는 웹 서비스입니다.</p>
          <ul className="list-disc pl-5 mt-3 space-y-1.5 text-white/70">
            <li>비로그인 이용자: 하루 2회 무료 이용 (워터마크 포함)</li>
            <li>카카오 로그인 이용자: 하루 10회 무료 이용 (워터마크 포함)</li>
            <li>크레딧 사용 이용자: 크레딧 차감 후 워터마크 없는 고화질 이미지 제공</li>
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2 text-white/70">
            <li>크레딧은 서비스 내 유료 기능(워터마크 제거 등) 이용에 사용되는 가상 화폐입니다.</li>
            <li>크레딧 패키지 가격은 서비스 내 상점 페이지에 명시되며, 사전 고지 없이 변경될 수 있습니다.</li>
            <li>결제는 카카오페이, 토스페이, 네이버페이 등 포트원(PortOne)을 통해 처리됩니다.</li>
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2 text-white/70">
            ...
            <li>환불 요청은 고객센터(이메일)를 통해 접수하며, 처리 기간은 영업일 기준 3~5일입니다.</li>
        ...
        <section>
          <h2 className="text-xl font-bold mb-3 text-white">제 6조 (워터마크 정책)</h2>
          <p>무료 이용 시 생성된 이미지에는 StyleDrop 워터마크가 자동으로 삽입됩니다. 크레딧을 사용하여 변환한 이미지에는 워터마크가 제거된 고화질 이미지가 제공됩니다.</p>
        </section>

        <section>
          <h2 className="text-xl font-bold mb-3 text-white">제 7조 (책임 한계 및 면책)</h2>
